function lightSwitch_on() // calling this variable from the HTML
{
    ...
    document.getElementById("s2").innerHTML= "As Drake would say <br> Look, I just flipped the switch (flipped, flipped)" // sentence that appeears when you press this button
}
